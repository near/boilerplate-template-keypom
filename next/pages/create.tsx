...
import { getKeysForDrop, setInactiveDrop, setKeysForDrop } from "../keyStore";
...
export default function CreateDrop() {
  ...
  //     setKeysForDrop(
  //       `drop#${dropId}`,
  //       keys.map(({ secretKey }) => secretKey.toString())
  //     );
  //     setInactiveDrop(dropId);
  ...
  //   const secretKeys: string[] = getKeysForDrop(dropId);
